...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='sglformer2_2_384_4', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='../../../dataset/ImageNet2012/', type=str,
                        help='dataset path')
    parser.add_argument('--nb_classes', default=1000, type=int,
                        help='number of the classification types')
    parser.add_argument('--print_freq', default=5000, type=int,
                        help='number of the train/test print frequence')
